    ...
    <div class="container-fluid">
        <div class="row min-vh-100 bg-100">
            <div class="col-6 d-none d-lg-block position-relative">
                <div class="bg-holder"
                     style="background-image:url(../../public/assets/img/layout/activate_account.jpg);background-position: 50% 30%;">
                </div>
            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <img class="d-block mx-auto mb-4"
                                         src="../../public/assets/img/icons/activate_account.png"
                                         alt="Email" width="96"/>
                                    <h3 class="mb-2">Sua conta foi ativada com sucesso!</h3>
                                    <p>Agora você pode conectar na sua conta.</p>
